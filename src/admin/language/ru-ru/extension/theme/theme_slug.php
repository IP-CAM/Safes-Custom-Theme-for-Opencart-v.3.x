...
$_['text_image']  = 'Images';
$_['text_top_navigation_links'] = 'Top navigation links';
...
$_['entry_top_navigation_links_add'] = 'Добавить ссылку';
$_['entry_top_navigation_links_delete'] = 'Удалить ссылку';
$_['entry_top_navigation_link_text'] = 'Текст';
$_['entry_top_navigation_link_url'] = 'Url';
$_['entry_top_navigation_link_sort_order'] = 'Порядок';
$_['entry_top_navigation_link_target'] = 'Атрибут target';
$_['entry_top_navigation_link_target_placeholder'] = 'default: _self';
$_['entry_top_navigation_link_attributes'] = 'Прочие атрибуты';
$_['entry_top_navigation_link_attributes_placeholder'] = 'например, rel=&quot;nofollow&quot;';
